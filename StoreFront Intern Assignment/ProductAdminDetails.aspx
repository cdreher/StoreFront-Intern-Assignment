...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron" style="border-style: dashed; border-width: 5px; border-color: #4166f5 #4166F5 #4166f5 #4166f5; font-family: 'Agency FB'; font-variant: normal; text-transform: inherit; color: #4166F5;">
        <div class="row" style="height:10px">
            <a href="ProductsAdmin.aspx"><img alt="Back" src="golf%20ball.png" style="width: 50px; height: 50px; float:left" /></a>
        </div>
    ...
    <div class ="row">
        ...
        <div class ="col-md-4">
            ...
            <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:StoreFrontConnectionString %>" SelectCommand="spGetProduct" SelectCommandType="StoredProcedure" UpdateCommand="spUpdateProduct" UpdateCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:QueryStringParameter Name="ProductID" QueryStringField="ProductID" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>
