<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebServiceTest.aspx.cs" Inherits="Week_3_Intern_Assignment.Service1Test" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron" style="border-style: dashed; border-width: 5px; border-color: #4166F5 #4166f5 #4166F5 #4166f5; font-family: 'Agency FB'; font-variant: normal; text-transform: inherit;">
       ...
       <h1 style="font-size: 40pt"><strong style="font-family: 'Agency FB'; color: #000080;">Web Service Test</strong></h1>
    </div>
    ...
    <div class ="row">
        ...
        <asp:Button ID="getProdDets" runat="server" Text="Product Details" OnClick="getProdDets_Click" />
